...
class Fitbit(object):
    ...
    def user_profile_get(self, user_id=None):
        ...
        """
        url = "{0}/1.2/user/{2}/profile.json".format(*self._get_common_args(user_id))
    ...
    def _COLLECTION_RESOURCE(self, resource, date=None, user_id=None,
        ...
        * https://dev.fitbit.com/docs/
        ...
        if not data:
            base_url = "{0}/1.2/user/{2}/{resource}/date/{date}.json"
        else:
            data['date'] = date_string
            base_url = "{0}/1.2/user/{2}/{resource}.json"
    ...
    def _DELETE_COLLECTION_RESOURCE(self, resource, log_id):
        ...
        """
        url = "{0}/1.2/user/-/{resource}/{log_id}.json".format(
    ...
    def _resource_goal(self, resource, data={}, period=None):
        ...
        url = "{0}/1.2/user/-/{resource}/goal{postfix}.json".format(
            *self._get_common_args(),
            resource=resource,
